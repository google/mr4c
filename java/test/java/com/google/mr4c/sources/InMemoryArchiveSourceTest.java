...
public class InMemoryArchiveSourceTest {
	...
	@Test public void testAddFileByOutputStream() throws Exception {
	...
	@Test public void testCopyToArchive() throws Exception {
		SourceTestUtils.populateSource(m_src);
		InMemoryArchiveSource dest = new InMemoryArchiveSource();
		SourceTestUtils.testCopySource(m_src, dest, true);
	}

	@Test public void testCopyToFiles() throws Exception {
		SourceTestUtils.populateSource(m_src);
		InMemoryFileSource dest = new InMemoryFileSource();
		SourceTestUtils.testCopySource(m_src, dest, true);
	}
