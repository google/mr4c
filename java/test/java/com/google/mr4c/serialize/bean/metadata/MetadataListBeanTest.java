...
public class MetadataListBeanTest {
	...
	@Test public void testList() {
		MetadataListBean bean = MetadataListBean.instance(m_list);
		MetadataList list2 = bean.toMetadataElement();
		assertEquals(m_list, list2);
	}
