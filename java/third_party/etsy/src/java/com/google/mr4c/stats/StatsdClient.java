/**
 * Google modified version of example client at https://github.com/etsy/statsd/blob/master/examples/StatsdClient.java
 *
 * StatsdClient.java
 *
 * (C) 2011 Meetup, Inc.
...
public class StatsdClient extends TimerTask implements StatsClient {
        private ByteBuffer sendBuffer;
        private Timer flushTimer;
        private boolean multi_metrics = false;

	private static final Random RNG = new Random();
	protected static final Logger log = MR4CLogging.getLogger(StatsdClient.class);
